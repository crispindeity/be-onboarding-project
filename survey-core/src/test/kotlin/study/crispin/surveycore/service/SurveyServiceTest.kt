        ...
        describe("설문 조사 업데이트 테스트") {
            ...
            context("정상적인 업데이트 요청일 때") {
                ...
                it("설문조사를 업데이트 할 수 있어야 한다.") {
                    ...
                    val createRequest = CreateSurveyUseCase.Request(
                        "관심사 조사",
                        "나이에 따른 관심사 조사",
                        items,
                    )
                    ...
                    val request = UpdateSurveyUseCase.Request(
                        createdSurvey.id!!,
                        "연령별 관심사 조사",
                        "연령에 따른 관심사 조사",
                    )
                    ...
                    // then
                    val actual: Survey = surveyService.findSurvey(
        ...
        describe("설문 조사 항목 업데이트 테스트") {
            ...
            context("정상적인 업데이트 요청일 때") {
                ...
                it("설문조사 항목을 업데이트 할 수 있어야 한다.") {
                    ...
                    val updateItems: List<SurveyItem> = listOf(
                        SurveyItem(
                            "이름",
                            "성함을 입력해주세요.",
                            Form.ShortInput,
